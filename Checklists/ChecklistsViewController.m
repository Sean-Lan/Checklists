...
- (void) loadChecklistItems {
    ...
    if ([[NSFileManager defaultManager] fileExistsAtPath:path]) {
        ...
        NSKeyedUnarchiver *unarchievr = [[NSKeyedUnarchiver alloc] initForReadingWithData:data];
        _items = [unarchievr decodeObjectForKey:@"ChecklistItems"];
        [unarchievr finishDecoding];
    } else {
